...
const photoFiles = [
  ...
  'revolution-square-6.jpg',
  'revolution-square-7.jpg',
  'revolution-square-8.jpg',
  'revolution-square-9.jpg',
  'revolution-square-10.jpg',
  'revolution-square-11.jpg',
  'revolution-square-12.jpg',
  'revolution-square-13.jpg',
];
...
export default function Gallery() {
  ...
  const photos = photoFiles.map((file, i) => ({
    src: `/gallery/${file}`,
    alt: captions?.[i] || `Revolution Square ${i + 1}`,
  }));
